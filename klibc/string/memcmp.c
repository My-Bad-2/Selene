...
static int memcmp_common_alignment(unsigned long srcp1, unsigned long srcp2, size_t len)
{
    ...
    do {
        ...
        if (a1 != b1) { return CMP_LT_OR_GT(a1, b1); }

    do3:
        a1 = ((op_t *)srcp1)[1];
        b1 = ((op_t *)srcp2)[1];

        if (a0 != b0) { return CMP_LT_OR_GT(a0, b0); }
...
static int memcmp_not_common_alignment(unsigned long srcp1, unsigned long srcp2, size_t len)
{
    op_t a0, a1, a2, a3;
    op_t b0, b1, b2, b3;
    op_t x;
    ...
    do {
        ...
        if (x != b3) { return CMP_LT_OR_GT(x, b3); }
    do3:
        a1 = ((op_t *)srcp1)[1];
        b1 = ((op_t *)srcp2)[1];
        x = MERGE(a3, shl, a0, shr);

        if (x != b0) { return CMP_LT_OR_GT(x, b0); }
    ...
    do2:
        ...
        if (x != b1) { return CMP_LT_OR_GT(x, b1); }
    ...
    do1:
        ...
        if (x != b2) { return CMP_LT_OR_GT(x, b2); }
